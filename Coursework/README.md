# Church of Uganda MIS Coursework

This folder contains the coursework deliverables for the CIS 7205 Advanced Database Systems project.

## Contents

- `analysis.md` - requirements analysis and stakeholder definitions.
- `ER_diagram.md` - conceptual design and entity relationships.
- `logical_schema.md` - relational schema and normalization justification.
